...
function getCompositeRect(e, t, n) {
    ...
    return !i && (i || n) || ("body" === getNodeName(t) && !isScrollParent(r) || (a = getNodeScroll(t)),
        isHTMLElement(t) ? ((s = getBoundingClientRect(t)).x += t.clientLeft,
            s.y += t.clientTop) : r && (s.x = getWindowScrollBarX(r))),
    {
...
function getTrueOffsetParent(e) {
    ...
    if (t) {
        ...
        if ("body" === getNodeName(t) && "static" === getComputedStyle(t).position && "static" !== getComputedStyle(n).position)
            return n
    }
    return t
}
...
function computeOffsets(e) {
    var t, n = e.reference, r = e.element, o = e.placement, i = o ? getBasePlacement(o) : null, a = o ? getVariation(o) : null, s = n.x + n.width / 2 - r.width / 2, c = n.y + n.height / 2 - r.height / 2;
    switch (i) {
        case top:
            t = {
                x: s,
        ...
        var l = {
            ...
            , d = {
                ...
                setOptions: function (e) {
                    i(),
                        l.options = Object.assign(Object.assign(Object.assign({}, c), l.options), e),
                        l.scrollParents = {
                    ...
                    return l.orderedModifiers = n.filter(function (e) {
                        ...
                        "production" !== process.env.NODE_ENV && (validateModifiers(uniqueBy([].concat(n, l.options.modifiers), function (e) {
                            ...
                            [(t = getComputedStyle(o)).marginTop, t.marginRight, t.marginBottom, t.marginLeft].some(function (e) {
                                return parseFloat(e)
                    ...
                    if (!f) {
                        ...
                        if (areValidElements(t, n)) {
                            ...
                            for (var r, o, i, a, s, c = 0, p = 0; p < l.orderedModifiers.length; p++) {
                                ...
                                !0 !== l.reset ? (o = (r = l.orderedModifiers[p]).fn,
                                    a = void 0 === (i = r.options) ? {} : i,
                                    s = r.name,
...
function mapToStyles(e) {
    var t, n, r = e.popper, o = e.popperRect, i = e.placement, a = e.offsets, s = e.position, c = e.gpuAcceleration, p = e.adaptive, l = roundOffsets(a), f = l.x, d = l.y, u = a.hasOwnProperty("x"), m = a.hasOwnProperty("y"), g = left, h = top, b = window;
    p && ((n = getOffsetParent(r)) === getWindow(r) && (n = getDocumentElement(r)),
        i === top && (h = bottom,
            d -= n.clientHeight - o.height,
            d *= c ? 1 : -1),
        i === left && (g = right,
            f -= n.clientWidth - o.width,
            f *= c ? 1 : -1));
    var v, y = Object.assign({
        position: s
    }, p && unsetSides);
    return c ? Object.assign(Object.assign({}, y), {}, ((v = {})[h] = m ? "0" : "",
        v[g] = u ? "0" : "",
        v.transform = (b.devicePixelRatio || 1) < 2 ? "translate(" + f + "px, " + d + "px)" : "translate3d(" + f + "px, " + d + "px, 0)",
        v)) : Object.assign(Object.assign({}, y), {}, ((t = {})[h] = m ? d + "px" : "",
            t[g] = u ? f + "px" : "",
            t.transform = "",
            t))
}
function computeStyles(e) {
    var t, n = e.state, r = e.options, o = r.gpuAcceleration, i = void 0 === o || o, a = r.adaptive, s = void 0 === a || a;
    "production" !== process.env.NODE_ENV && (t = getComputedStyle(n.elements.popper).transitionProperty || "",
...
function applyStyles(e) {
    ...
    Object.keys(o.elements).forEach(function (e) {
        var t = o.styles[e] || {}
            , n = o.attributes[e] || {}
            , r = o.elements[e];
        isHTMLElement(r) && getNodeName(r) && (Object.assign(r.style, t),
            Object.keys(n).forEach(function (e) {
                var t = n[e];
    ...
    return Object.assign(o.elements.popper.style, i.popper),
        ...
        function () {
            Object.keys(o.elements).forEach(function (e) {
                ...
                isHTMLElement(t) && getNodeName(t) && (Object.assign(t.style, r),
                    Object.keys(n).forEach(function (e) {
                        t.removeAttribute(e)
                    }))
            })
...
function offset(e) {
    var n = e.state
        ...
        , a = placements.reduce(function (e, t) {
            return e[t] = distanceAndSkiddingToXY(t, n.rects, i),
                e
        }, {})
        , s = a[n.placement]
        , c = s.x
        , p = s.y;
    null != n.modifiersData.popperOffsets && (n.modifiersData.popperOffsets.x += c,
...
function flip(e) {
    ...
    if (!n.modifiersData[r]._skip) {
        ...
        n.placement !== x && (n.modifiersData[r]._skip = !0,
            n.placement = x,
            n.reset = !0)
    }
}
...
function preventOverflow(e) {
    var t, n, r, o, i, a, s, c, p, l, f, d, u, m, g, h, b, v, y, O, w, E, P, x, S, R, M, N = e.state, D = e.options, j = e.name, T = D.mainAxis, I = void 0 === T || T, L = D.altAxis, C = void 0 !== L && L, A = D.boundary, B = D.rootBoundary, _ = D.altBoundary, V = D.padding, W = D.tether, k = void 0 === W || W, F = D.tetherOffset, H = void 0 === F ? 0 : F, q = detectOverflow(N, {
        boundary: A,
        rootBoundary: B,
        padding: V,
        altBoundary: _
    }), $ = getBasePlacement(N.placement), G = getVariation(N.placement), U = !G, X = getMainAxisFromPlacement($), Y = getAltAxis(X), z = N.modifiersData.popperOffsets, J = N.rects.reference, K = N.rects.popper, Q = "function" == typeof H ? H(Object.assign(Object.assign({}, N.rects), {}, {
    ...
    z && (I && (t = "y" === X ? top : left,
        ...
        p = G === start ? -K[r] : -J[r],
        l = N.elements.arrow,
        f = k && l ? getLayoutRect(l) : {
            width: 0,
            height: 0
        },
        u = (d = N.modifiersData["arrow#persistent"] ? N.modifiersData["arrow#persistent"].padding : getFreshSideObject())[t],
        m = d[n],
        g = within(0, J[r], f[r]),
        h = U ? J[r] / 2 - s - g - u - Q : c - g - u - Q,
        b = U ? -J[r] / 2 + s + g + m + Q : p + g + m + Q,
        y = (v = N.elements.arrow && getOffsetParent(N.elements.arrow)) ? "y" === X ? v.clientTop || 0 : v.clientLeft || 0 : 0,
        O = N.modifiersData.offset ? N.modifiersData.offset[N.placement][X] : 0,
        w = z[X] + h - O - y,
        E = z[X] + b - O,
        P = within(k ? Math.min(i, w) : i, o, k ? Math.max(a, E) : a),
        z[X] = P,
        Z[X] = P - o),
        C && (x = "x" === X ? top : left,
            S = "x" === X ? bottom : right,
            M = within((R = z[Y]) + q[x], R, R - q[S]),
            z[Y] = M,
            Z[Y] = M - R),
        N.modifiersData[j] = Z)
}
...
function arrow(e) {
    var t, n, r, o, i, a, s, c, p, l, f, d, u, m, g = e.state, h = e.name, b = g.elements.arrow, v = g.modifiersData.popperOffsets, y = getBasePlacement(g.placement), O = getMainAxisFromPlacement(y), w = 0 <= [left, right].indexOf(y) ? "height" : "width";
    b && v && (n = g.modifiersData[h + "#persistent"].padding,
        r = getLayoutRect(b),
        o = "y" === O ? top : left,
        i = "y" === O ? bottom : right,
        a = g.rects.reference[w] + g.rects.reference[O] - v[O] - g.rects.popper[w],
        s = v[O] - g.rects.reference[O],
        p = (c = getOffsetParent(b)) ? "y" === O ? c.clientHeight || 0 : c.clientWidth || 0 : 0,
        l = a / 2 - s / 2,
        f = n[o],
        d = p - r[w] - n[i],
        m = within(f, u = p / 2 - r[w] / 2 + l, d),
        g.modifiersData[h] = ((t = {})[O] = m,
            t.centerOffset = m - u,
            t))
}
function effect$2(e) {
    var t = e.state
        ...
        , a = n.padding
        , s = void 0 === a ? 0 : a;
    null != i && ("string" == typeof i && !(i = t.elements.popper.querySelector(i)) || ("production" !== process.env.NODE_ENV && (isHTMLElement(i) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))),
        contains(t.elements.popper, i) ? (t.elements.arrow = i,
